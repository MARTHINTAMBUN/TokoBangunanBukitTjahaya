        ...
        <div class="divcontent2">
          ...
          <div class="divcontainer-fluid2">
            ...
            <div class="divcard2">
              ...
              <form action="{{route('admin.product.update', $barang->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="formh2d-5d1009c81">
                <div class="divform-group8">
                  <div class="nama2">Nama</div>
                  <input type="text" class="inputname1" name="nama" value="{{$barang->nama}}">
                </div>
                <div class="divform-group8">
                  <div class="nama2">Harga</div>
                  <input type="number" class="inputname1" name="harga" value="{{$barang->harga}}">
                </div>
                <div class="divform-group8">
                ...
                <div class="divform-group8">
                  <div class="nama2">Jumlah</div>
                      <input type="number" class="inputname1" name="jumlah" value="{{$barang->jumlah}}">
                </div>
                <div class="divform-group15">
                  <div class="nama2">Deskripsi</div>
                  <textarea class="inputname1" name="deskripsi" rows="5" cols="40">{{$barang->deskripsi}}</textarea>
                </div>
                <div>
