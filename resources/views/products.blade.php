...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/css/Animated-Pretty-Product-List-v12-Animated-Pretty-Product-List.css') }}">
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/css/Pop-Out-Vertical-Nav-w-Footer--Social-Links--1-Vertical-Nav.css') }}">
...
<body>
    ...
    <section class="py-5" style="border-width: 1px;box-shadow: inset 0px 0px 20px 0px var(--bs-body-color);">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('assets/img/slider1.jpeg')}}" class="d-block w-100" alt="slide1">
    </div>
    <div class="carousel-item">
      <img src="{{asset('assets/img/slider2.jpeg')}}" class="d-block w-100" alt="slide2">
    </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>   
        ...
        <div class="row mb-4 mb-lg-5" style="margin-top: 43px;">
            <div class="col-md-8 col-xl-6 text-center mx-auto" id="product">
                ...
                @foreach ($barang as $item)
                    <div class="col-sm-6 col-md-4 product-item animation-element slide-fade-xslow">
                        <a href="{{ route('product', $item->id) }}">
                            <div class="product-container" style="border-radius: 12px;">
                                <div class="row">
                                    <div class="col-md-12"><a class="product-image" href="{{ route('product', $item->id) }}"><img
                                                src="{{ asset('uploads/barang/' . $item->gambar) }}"
                                                style="height: 185px;"></a></div>
                                </div>
                                <div class="row">
                                    <div class="col-8">
                                        <h2><a href="{{ route('product', $item->id) }}">{{ $item->nama }}</a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        </h2>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <p class="product-description">{{ Str::limit($item->deskripsi, 120) }}</p>
                                        <div class="row">
                                            </a>
                                            <div class="col-6"><img src="assets/img/Polygon%201.png" width="23"
                                                    height="23"><a href="{{ route('product', $item->id) }}"><button class="btn btn-light" type="button"
                                                    style="background: rgba(255,76,41,0);color: #ff4b30;padding-left: 11px;position: relative;border-style: none;">Shop
                                                    Now</button> </a>
                                                </div>
                                            <div class="col-6">
                                                <p class="product-price" style="font-size: 18px;color: rgb(255,74,53);">
                                                    IDR {{ $item->harga }}</p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="container py-5" style="box-shadow: inset 0px 0px;">
            <nav class="d-lg-flex d-xl-flex justify-content-lg-center justify-content-xl-center">
                <ul class="pagination">
